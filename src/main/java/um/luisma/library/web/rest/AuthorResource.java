...
import um.luisma.library.repository.AuthorRepository;
import um.luisma.library.service.AuthorQueryService;
import um.luisma.library.service.AuthorService;
import um.luisma.library.service.criteria.AuthorCriteria;
import um.luisma.library.service.dto.AuthorDTO;
import um.luisma.library.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link um.luisma.library.domain.Author}.
 */
@RestController
@RequestMapping("/api")
