...
/**
 * Criteria class for the {@link um.luisma.library.domain.Book} entity. This class is used
 * in {@link um.luisma.library.web.rest.BookResource} to receive all the possible filtering options from
