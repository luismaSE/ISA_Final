...
/**
 * Criteria class for the {@link um.luisma.library.domain.Client} entity. This class is used
 * in {@link um.luisma.library.web.rest.ClientResource} to receive all the possible filtering options from
