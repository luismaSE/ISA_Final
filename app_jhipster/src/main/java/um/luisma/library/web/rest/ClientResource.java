...
import um.luisma.library.repository.ClientRepository;
import um.luisma.library.service.ClientQueryService;
import um.luisma.library.service.ClientService;
import um.luisma.library.service.criteria.ClientCriteria;
import um.luisma.library.service.dto.ClientDTO;
import um.luisma.library.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link um.luisma.library.domain.Client}.
 */
@RestController
@RequestMapping("/api")
