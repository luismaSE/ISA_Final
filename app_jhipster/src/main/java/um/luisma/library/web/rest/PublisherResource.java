...
import um.luisma.library.service.PublisherQueryService;
import um.luisma.library.service.PublisherService;
import um.luisma.library.service.criteria.PublisherCriteria;
import um.luisma.library.service.dto.PublisherDTO;
import um.luisma.library.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link um.luisma.library.domain.Publisher}.
 */
@RestController
@RequestMapping("/api")
