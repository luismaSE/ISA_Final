...
import um.luisma.library.service.BorrowedBookQueryService;
import um.luisma.library.service.BorrowedBookService;
...
/**
 * REST controller for managing {@link um.luisma.library.domain.BorrowedBook}.
 */
@RestController
@RequestMapping("/api")
